...
$python ${L1EM_utilities_dir}filtered_and_normalized_active_l1md.py names_final.pkl X_final.pkl $(head -2 ../baminfo.txt | tail -1) $(head -3 ../baminfo.txt | tail -1)> ../filter_active_L1Md_FPM.txt
